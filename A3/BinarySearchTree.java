 ...
 * 
 * MODIFICIATION: Added height variable to BST Node class. Modified compare methods 
 * to ignore case. Also added height methods. 
 *
...
public class BinarySearchTree<E extends Comparable<? super E>> implements
    ...
    protected class BSTNode {
        ...
        /**
         * ADDED: The height of the node. Mainly used for AVL implementation.
         */
        public int height;
    ...
    protected String dump(BSTNode root) {
     ...
     /**
      * Height methods. Will mainly be used by AVL tree. 
      */
    public int height() {
		if (overallRoot == null)
			return 0;
